...
batch-job-amd64:
	docker build -f batch-job/Dockerfile -t geoffgarside/batch-job-amd64:${RELEASE} batch-job

batch-job-arm64:
	docker build -f batch-job/Dockerfile.arm64 -t geoffgarside/batch-job-arm64:${RELEASE} batch-job
...
kubia-amd64:
	docker build -f kubia/Dockerfile -t geoffgarside/kubia-amd64:${RELEASE} kubia

kubia-arm64:
	docker build -f kubia/Dockerfile.arm64 -t geoffgarside/kubia-arm64:${RELEASE} kubia
...
kubia-pet-set-amd64:
	docker build -f kubia-pet-set/Dockerfile -t geoffgarside/kubia-pet-set-amd64:${RELEASE} kubia-pet-set

kubia-pet-set-arm64:
	docker build -f kubia-pet-set/Dockerfile.arm64 -t geoffgarside/kubia-pet-set-arm64:${RELEASE} kubia-pet-set
...
kubia-unhealthy-amd64:
	docker build -f kubia-unhealthy/Dockerfile -t geoffgarside/kubia-unhealthy-amd64:${RELEASE} kubia-unhealthy

kubia-unhealthy-arm64:
	docker build -f kubia-unhealthy/Dockerfile.arm64 -t geoffgarside/kubia-unhealthy-arm64:${RELEASE} kubia-unhealthy
...
ssd-monitor-amd64:
	docker build -f ssd-monitor/Dockerfile -t geoffgarside/ssd-monitor-amd64:${RELEASE} ssd-monitor

ssd-monitor-arm64:
	docker build -f ssd-monitor/Dockerfile.arm64 -t geoffgarside/ssd-monitor-arm64:${RELEASE} ssd-monitor
